...
void setup() {
  ...
  sou= minim.loadFile("02 - Do You Want to Build a Snowman_.mp3");                                              // Do you wanna build a snowman?
  sou.loop();                                                                                                        //Loop
}
...
void draw() {
  ...
  if (mouseX>exit2buttonx-80 && mouseX<exit2buttonx+80 && mouseY>exit2buttony-30 && mouseY<exit2buttony+30) {    //if the mouse is in the are of the exit button
    if (mousePressed == true) {                                                                                  //and mouse is pressed
      exit();                                                                                                    //exit program
    }
  }
